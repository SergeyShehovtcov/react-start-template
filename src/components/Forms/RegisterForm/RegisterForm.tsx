...
export const RegisterForm: FC = (): ReactElement => {
  ...
  const submit: SubmitHandler<RegisterForm> = (data) => {
    console.log('Валидные данные из формы, выведенные в консоль: ', data);
    reset({
      name: '',
      email: '',
      phone: '',
        ...
        <div className="col-md-6 offset-md-3">
          <form onSubmit={handleSubmit(submit, error)}>
            <div className="mb-3">
              ...
              />
              <div className={cn('invalid-feedback', { show: errors.name || false })}>Name is required</div>
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              />
              <div className={cn('invalid-feedback', { show: errors.phone || false })}>Phone is required</div>
            </div>
            <div className="mb-3">
              ...
              />
              <div className={cn('invalid-feedback', { show: errors.password || false })}>Password is required</div>
            </div>
            <div className="mb-3">
